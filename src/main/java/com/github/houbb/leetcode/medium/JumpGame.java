...
public class JumpGame {
     ...
     *
     *【解题思路】
     * 基本思想是：在每个步骤中，我们都跟踪最远的可到达索引。 问题的本质（例如，您可以击中一个目标范围的最大跳跃，而不是您只能击中一个目标的奇异跳跃）是要使一个索引可以到达，必须使每个先前的索引都可以到达。
     *
     * 因此，我们迭代每个索引就足够了，如果遇到无法访问的索引，我们将中止并返回false。 到最后，我们将迭代到最后一个索引。 如果循环结束，则最后一个索引是可到达的。
     *
     * @param nums
     * @return
     */
