 ...
 * @since 1.0.0
 */
public class SubstringWithConcatenationOfAllWordsSlideWindowOptimize {
    ...
    public static void main(String[] args) {
        SubstringWithConcatenationOfAllWordsSlideWindowOptimize allWords = new SubstringWithConcatenationOfAllWordsSlideWindowOptimize();
