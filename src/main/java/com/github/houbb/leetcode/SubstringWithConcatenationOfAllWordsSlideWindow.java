 ...
 * @since 1.0.0
 */
public class SubstringWithConcatenationOfAllWordsSlideWindow {
    ...
    public static void main(String[] args) {
        SubstringWithConcatenationOfAllWordsSlideWindow allWords = new SubstringWithConcatenationOfAllWordsSlideWindow();
