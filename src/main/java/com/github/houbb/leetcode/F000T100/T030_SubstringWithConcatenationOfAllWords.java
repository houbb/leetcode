 ...
 * @since 1.0.0
 */
public class T030_SubstringWithConcatenationOfAllWords {
    ...
    public static void main(String[] args) {
        T030_SubstringWithConcatenationOfAllWords allWords = new T030_SubstringWithConcatenationOfAllWords();
